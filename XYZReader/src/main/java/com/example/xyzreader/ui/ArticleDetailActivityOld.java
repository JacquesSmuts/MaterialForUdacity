 ...
 */
public class ArticleDetailActivityOld extends AppCompatActivity
    ...
    public static Intent getIntent(Context context, long selectedItemId){
        Intent intent = new Intent(context, ArticleDetailActivityOld.class);
...
//        }
    ...
    private class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            mCursor.moveToPosition(position);
            return ArticleDetailFragmentOld.newInstance(mCursor.getLong(ArticleLoader.Query._ID));
        }
